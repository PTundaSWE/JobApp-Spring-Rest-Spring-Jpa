...
public class JobAppSpringRestSpringJpaApplication {
    ...
    public static void main(String[] args) {
       ...
       JobRepo repo = context.getBean(JobRepo.class);
        ...
        jobPost1.setPostTechStack("Core Java, J2EE, Spring Boot, Hibernate");
        ...
        jobPost2.setPostTechStack("HTML, CSS, JavaScript, React");
        ...
        jobPost3.setPostTechStack("Python, Machine Learning, Data Analysis");
        ...
        jobPost4.setPostTechStack("Networking, Cisco, Routing, Switching");
        ...
        jobPost5.setPostTechStack("iOS Development, Android Development, Mobile App");
